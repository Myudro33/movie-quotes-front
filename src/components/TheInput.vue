      ...
      :class="
        style
          ? `xs:border-b md:border-2 ${
            ...
            } md:px-5  xs:bg-transparent md:bg-white xs:outline-none md:outline md:rounded-[4px] xs:text-white md:text-black`
          : ` ${error ? 'border-red-500' : 'border-gray-500'} px-5 border-2  rounded-[4px]`
      "
      :id="id"
      :name="id"
      :type="localType"
